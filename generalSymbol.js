...
function generalSymbol(str1, str2) {
    /*далее объявляем костанту  arrayOfI2, присваиваем ей пустой массив(там будет хранится количество общих символов*/
    const arrayOfI2 = []
    ...
    for (let i1 = 0; i1 < str1.length; i1++) {
        ...
        for (let i2 = 0; i2 < str2.length; i2++) {
            /*если индекс элемента первой строки равен индексу элемента второй и индекс второй строки не присутсвует 
             в массиве совпадений, тогда добавляем i2 в  arrayOfI2 */
            if (str1[i1] == str2[i2]) {
