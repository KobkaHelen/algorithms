...
function generalSymbol(str1, str2) {
    /*далее объявляем константу  arrayOfI2, присваиваем ей пустой массив(там будут храниться индексы второй строки.)
        Длинна массива совпадений будет равна количеству общих символов*/
    const arrayOfI2 = []
