...
function generalSymbol(str1, str2) {
    /*далее объявляем константу  arrayOfI2, присваиваем ей пустой массив(там будет хранится количество общих символов.
        Длинна массива совпадений будет равна количеству общих сомволов*/
    const arrayOfI2 = []
    ...
    for (let i1 = 0; i1 < str1.length; i1++) {
        ...
        for (let i2 = 0; i2 < str2.length; i2++) {
            ...
            if (str1[i1] == str2[i2]) {
                /*Объявляем переменную существующие (имеется ввиду совпадения)и присваиваем ей значение false,
